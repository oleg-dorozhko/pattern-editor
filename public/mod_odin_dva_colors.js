console.log('mod odin dva colors on');
var PNG = require('pngjs').PNG;
//var mod_mirror = require('./mod_mirror');
//var mod_median = require('./mod_median');
module.exports.odinDvaColorsForImageData = odinDvaColorsForImageData;
...
function get_array_of_colors(im0)
{
	...
	****/		
		...
		//	for (var i = 0; i < arr2.length; i++) 
			{
		//		console.log ( arr2[i]+": "+obj[(""+arr2[i][0]+"-"+arr2[i][1]+"-"+arr2[i][2]+"-"+arr2[i][3])].cnt);
			}
...
function odinDvaColorsForImageData(im)
{
	var w = im.width;
	var h = im.height;
